...
class BelanjainCourierHistoryScreen extends StatefulWidget {
  const BelanjainCourierHistoryScreen({super.key});

  @override
  State<BelanjainCourierHistoryScreen> createState() =>
      BelanjainCourierHistoryScreenState();
}

class BelanjainCourierHistoryScreenState
    extends State<BelanjainCourierHistoryScreen> {
  @override
        ...
        Container(
          ...
          child: Column(
            children: [
                        ...
                        children: [
                          Padding(
                            ...
                            child: SvgPicture.asset(
                                IntransporiaImages.courierOrderShoppingBasket),
                          ),
                          SizedBox(width: 16),
                          Expanded(
                            child: Column(
              ...
              Padding(
                padding: EdgeInsets.fromLTRB(18, 4, 24, 14),
                child: Row(
                  mainAxisAlignment: MainAxisAlignment.spaceBetween,
                  children: [
                    Text(
